...
```bash
npx create-next-app --example [Github Repo Link] <YOUR_APP_NAME>
```

```bash
yarn create next-app --example [Github Repo Link] <YOUR_APP_NAME>
```

```bash
pnpm create next-app --example [Github Repo Link] <YOUR_APP_NAME>
```
